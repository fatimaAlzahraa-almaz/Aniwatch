...
const LoadingColCard = () => {
  return (
    <div className='flex items-center  sm:h-[8rem] h-[7rem]  w-full border-b border-b-gray-700/70 relative   sm:gap-3 gap-2 '>
 <div  className=' w-[4rem]  aspect-2/3 rounded-xl  bg-gray-600  '></div>
